 ...
 * @author Sabari
 */
public class AddPhrasalVerb extends javax.swing.JFrame {
    ...
    public AddPhrasalVerb(AddWord parent, DictionaryInterface di) {
        initComponents();
        this.parent = parent;
        this.di = di;
    ...
    private void setActionSubmit(ActionEvent ae){
        ...
        if(form.length() == 0){
            warnings.setText("Phrasal Verb form cannot be empty");
        }
            ...
            try{           
                di.addPhrasalVerb(form, meaning, example);
                parent.updatePhrasalVerbList(form);
                setVisible(false);
